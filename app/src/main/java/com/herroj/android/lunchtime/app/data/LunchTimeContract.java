...
public final class LunchTimeContract {
    ...
    public static final String FILTRO_COMIDA = "1";

    public static final String FILTRO_DESAYUNO = "2";
    ...
    static final String PATH_PLATILLO = "platillo";
    ...
    /**
     * Platillo entry es una clase interna que define el contenido de la tabla Platillo
     */
    public static class PlatilloEntry implements BaseColumns {
         ...
         */
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_PLATILLO).build();
         ...
         * COLUMN_RESTAURANT contiene el nombre del campo restaurant
         */
        public static final String COLUMN_PLATILLO = "platillo";
         ...
         * COLUMN_TIPO_RESTAURANT contiene el nombre del campo tipo de restaurant
         */
        public static final String COLUMN_TIPO_PLATILLO = "tipoPlatillo";
        ...
        static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + File.separator +
                        CONTENT_AUTHORITY + File.separator + PATH_PLATILLO;
         ...
         * @return devuelve la uri que identifica el elemento requerido
         */
        static Uri buildPlatilloUri(final long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }

        public static Uri BuildPlatilloPorTipo(){
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_TIPO_PLATILLO, s_filtroSeleccionado).build();
        }
         ...
         * @return the uri
         */
        public static Uri buildPlatilloPorNombreUri(final String nombre) {
            return CONTENT_URI.buildUpon().appendPath(nombre).build();
        }
         ...
         * @return el restaurante se obtiene del segundo segmento del uri
         */
        static String getPlatilloSettingFromUri(final Uri uri) {
            return uri.getPathSegments().get(1);
        }
